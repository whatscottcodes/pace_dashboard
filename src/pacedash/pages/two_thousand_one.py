...
image_urls = ['https://m.media-amazon.com/images/M/MV5BMTUwYjczNmItYzczNS00MDQwLTkxNDctN2MwYzI5YzhmNGU4XkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_UX182_CR0,0,182,268_AL_.jpg',
...
layout = html.Div([
    Row([
    Col(create_list(titles)),
    Col(create_images(image_urls))
    ], style={
                "margin-top": "4vh",
                "display": "flex",
                "flex-direction": "row",
